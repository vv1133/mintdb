#ifndef __PMDEDUMGR_HPP__
#define __PMDEDUMGR_HPP__
...
private :
    ...
    * Return:
    *   MDB_OK (success)
    *   MDB_SYS (the given eduid can't be found)
    *   MDB_EDU_INVAL_STATUS (EDU is found but not with expected status)
    */
    ...
    * Return:
    *   MDB_OK (success)
    *   MDB_SYS (the given eduid can't be found, or it's not AGENT)
